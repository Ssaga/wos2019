...
class WosBattleManager(WosPhaseManager):
    ...
    def __init__(self, wos_interface, parent=None):
        ...
        self.features.append(WosBattleCoreManager(wos_interface))
        self.features.append(WosSatelliteEoManager(wos_interface))
        self.features.append(WosSatelliteEo2Manager(wos_interface))
