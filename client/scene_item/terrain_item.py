...
class WosTerrainItem(WosBattlefieldItem):
    ...
    def __init__(self, field_info, x, y, t):
        ...
        self.terrains = {cCommonGame.MapData.WATER: 'Sea',
        ...
        self.brushes[cCommonGame.MapData.BLACK] = [QBrush(QColor(50, 50, 50, 255), Qt.SolidPattern),
                                                   QBrush(QColor(0, 0, 0, 255), Qt.FDiagPattern)]
    ...
    def set_terrain_type(self, t):
        self.terrain_type = t
        if self.terrain_type == cCommonGame.MapData.WATER or self.terrain_type == cCommonGame.MapData.ISLAND or \
                self.terrain_type == cCommonGame.MapData.BLACK:
    ...
    def show_tool_tip(self, event):
        ...
        if self.terrain_type == cCommonGame.MapData.WATER or self.terrain_type == cCommonGame.MapData.BLACK:
